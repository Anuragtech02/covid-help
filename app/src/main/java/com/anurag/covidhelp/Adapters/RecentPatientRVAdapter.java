...
public class RecentPatientRVAdapter extends RecyclerView.Adapter<RecentPatientRVAdapter.PatientCardView> {

    private ArrayList<PatientModel> patients;
    private LayoutInflater layoutInflater;
    private View.OnClickListener onItemClickListener;

    public RecentPatientRVAdapter(Context context, ArrayList<PatientModel> patients) {
...
//        Log.d("PATIENTS", patients.size() + patients.get(0).name);
    ...
    public PatientCardView onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.recent_patient_card, parent, false);
...
//        Log.d("CURR_PATIENT", currPatient.toString());
        ...
        holder.patientName.setText(String.valueOf(currPatient.name));
        holder.bed.setText(String.valueOf(currPatient.bed));
    }
